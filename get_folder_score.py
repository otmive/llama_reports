...
import os
import csv
from get_llama_score import compare
...
def run_main(
    ...
    if llama_score == False:
        ...
        for folder in os.listdir(folder_path):
            ...
            score = compare(f"{folder_path}/{folder}/{final_report}", f"{folder_path}/{folder}/{prelim_report}")
